...
5. The host's entropy source is not compromised.
6. Whoever holds the approval key is not the adversary.

## Review triggers

Re-read this document when: threshold signing lands, a second chain is added, an
